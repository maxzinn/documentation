/*
* Kendo UI v2014.1.624 (http://www.telerik.com/kendo-ui)
...
(function($, undefined) {
    ...
    var Window = Widget.extend({
        ...
        maximize: sizingAction("maximize", function() {
            ...
            var mainTop = parseInt($('#application_main').css('top'));
        ...
        _onDocumentResize: function () {
            ...
            var mainTop = parseInt($('#application_main').css('top')) + 20;

            wrapper.css({
                    width: parseInt(w -20),
                    height: parseInt(h - mainTop)
                });
